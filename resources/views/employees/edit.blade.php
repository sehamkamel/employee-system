...
<div class="container">
    ...
    <form action="{{ route('employees.update', $employee->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select id="department-select" name="department" class="form-control" required>
                ...
                @foreach($departments as $d)
                    <option value="{{ $d['name'] }}" 
                        {{ old('department', $employee->department) == $d['name'] ? 'selected' : '' }}>
                        {{ $d['name'] }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-3">
            ...
            <input id="hired_at" type="date" name="hired_at" class="form-control" 
...
<script>
    ...
    const oldDepartment = {!! json_encode(old('department', $employee->department)) !!};
    const oldJobTitle = {!! json_encode(old('job_title', $employee->job_title)) !!};
